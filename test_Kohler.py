...
parser.add_argument('--input_dir', default='./datasets/Kohler_multi2/', type=str, help='Input images')
parser.add_argument('--result_dir', default='./res_kohler2/', type=str, help='Directory for results')
