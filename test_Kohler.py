...
parser.add_argument('--input_dir', default='./datasets/Kohler_multi1/', type=str, help='Input images')
parser.add_argument('--result_dir', default='./res_kohler1/', type=str, help='Directory for results')
