...
parser.add_argument('--input_dir', default='./datasets/test_real_images/', type=str, help='Input images')
parser.add_argument('--result_dir', default='./res_real/', type=str, help='Directory for results')
